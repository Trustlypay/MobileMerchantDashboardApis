...
//
//import com.example.MerchantDashboardApis.Services.PayinVendorSummaryService;
...
//@CrossOrigin(origins = "*")
//public class PayinVendorSummaryController {
//
//    private final PayinVendorSummaryService payinVendorSummaryService;
//
//    public PayinVendorSummaryController(PayinVendorSummaryService payinVendorSummaryService) {
//        this.payinVendorSummaryService = payinVendorSummaryService;
//    }
//
//    @GetMapping("/payin-vendor-summary")
//    @Operation(
//            summary = "Get Payin Vendor Summary",
...
//    ) {
//        return ResponseEntity.ok(payinVendorSummaryService.getVendorSummary(merchantId, fromDate, toDate));
//    }
//}
